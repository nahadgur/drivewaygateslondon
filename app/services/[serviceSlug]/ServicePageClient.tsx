...
export function ServicePageClient({ params }: { params: { serviceSlug: string } }) {
  ...
  const relatedPosts = (related?.posts ?? [])
    .map(slug => publishedArticles.find(b => b.slug === slug))
        ...
        <section className="grid grid-cols-1 lg:grid-cols-[1fr_400px] xl:grid-cols-[1fr_480px] border-b-[3px] border-brand-900 min-h-[60vh] lg:min-h-[82vh]">
          ...
          <div className="flex flex-col justify-center px-6 sm:px-10 lg:px-14 py-14 lg:py-16 border-b-[3px] lg:border-b-0 lg:border-r-[3px] border-brand-900 bg-brand-50">
            ...
            <div className="flex flex-wrap gap-x-8 gap-y-3">
              {['Free site survey and written quote', 'We design, supply and install', `${totalCities}+ London locations`].map(item => (
          ...
          <div className="flex items-center justify-center bg-brand-100 px-6 py-10 lg:px-8 lg:py-12 min-h-[280px] lg:min-h-0">
            <div className="w-full max-w-md">
              <HeroLeadForm service={gateTypeForSlug(service.slug)} />
            </div>
          </div>
        </section>
            ...
            <aside className="lg:col-span-1">
              <div className="sticky top-28 space-y-4">
                <div className="border-2 border-brand-900 p-6 bg-brand-50">
                  ...
                  <h3 className="font-syne font-bold text-sm uppercase tracking-tight text-brand-900 mb-3">Get a Quote for {service.title}</h3>
                  <p className="text-brand-600 text-sm mb-5">Fill in the short form and we call you back within 24 hours to arrange a free site survey.</p>
