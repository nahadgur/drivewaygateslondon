...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'We install industrial security gates, school gate systems, car park barriers, and heavy-duty sliding gates across London.',
  ...
  twitter: { card: 'summary_large_image', title: 'Commercial Gate Systems London', description: 'We install industrial security gates, school gate systems, and car park barriers across London.' },
};
