...
export const accessControlServices: AccessControlService[] = [
  ...
  },
  {
    ...
    intro: [
      ...
      "All keypads we install are IP65 rated or better for weatherproofing, backlit for night use, and anti-vandal rated where required. Wired keypads connect directly to the gate motor control board. Wireless keypads use encrypted radio transmission and require only a power source. We recommend the right type based on your gate layout and the distance from the gate post to the property.",
    ],
    benefits: [
  ...
  },
  {
    ...
    intro: [
      ...
      "We work with several ANPR providers depending on your requirements and budget. Residential systems start from around £1,500 fully installed and are ideal for households with two or more regularly driven vehicles. We also design and install commercial systems with multiple camera positions, vehicle tracking, and integration into site security management platforms.",
    ],
    benefits: [
